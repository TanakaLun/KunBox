...
object KryoSerializer {
    ...
    private fun createKryo(): Kryo {
        return Kryo().apply {
            ...
            // 注册设置相关类 (SettingsStore 使用)
            register(AppSettings::class.java)
            register(CustomRule::class.java)
            register(RuleSet::class.java)
            register(RuleSetType::class.java)
            register(RuleSetOutboundMode::class.java)
            register(AppRule::class.java)
            register(AppGroup::class.java)
            register(AppInfo::class.java)
            register(NodeFilter::class.java)
            register(FilterMode::class.java)
            register(NodeSortType::class.java)
            register(RuleType::class.java)
            register(OutboundTag::class.java)
            register(LatencyTestMethod::class.java)
            register(TunStack::class.java)
            register(VpnRouteMode::class.java)
            register(VpnAppMode::class.java)
            register(DnsStrategy::class.java)
            register(RoutingMode::class.java)
            register(DefaultRule::class.java)
            register(AppThemeMode::class.java)
            register(AppLanguage::class.java)
            register(GhProxyMirror::class.java)
